...
#
# Generated by export_simulation on Fri Apr 01 12:01:51 +0900 2022
#
################################################################################
...
'-reset_run' switch to the './xbip_multadd_mymultadd.sh' script.

./xbip_multadd_mymultadd.sh -reset_run
...
./xbip_multadd_mymultadd.sh -noclean_files

For more information on the script, please type './xbip_multadd_mymultadd.sh -help'.
